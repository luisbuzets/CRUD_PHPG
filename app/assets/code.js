...
const app = new (function () {
  ...
  /**********************MOSTRAR LOS CLIENTES DESDE POSTGRESQL  ********* */
  ...
  /**********************GUARDAR LOS CLIENTES DEL FRONTEND HACIA  POSTGRESQL  ********* */
  this.guardar = () => {
  ...
  /**********************EDITAR LOS CLIENTES DESDE FRONTEND A  POSTGRESQL  ********* */
  this.editar = (id) => {
    var form = new FormData();
    form.append("id", id);
  ...
  /**********************ELIMINAR LOS CLIENTES DESDE FRONTEND A  POSTGRESQL  ********* */
  this.eliminar = (id) => {
    var form = new FormData();
    form.append("id", id);
  ...
  /**********************LIMPIAR LA LISTA LOS CLIENTES EN EL FRONTEND Y LUEGO ACTUALIZA EN POSTGRES  ********* */
  this.limpiar = () => {
...
const apps = new (function () {
  ...
  /**********************MOSTRAR LOS EMPLEADO POSTGRESQL Y VISIBLE EN EL FRONTEND ********* */
  ...
  /**********************GUARDAR LOS EMPLEADO DESDE EL FRONTEND HACIA  POSTGRESQL  ********* */
  ...
  /**********************EDITAR LOS EMPLEADO DESDE EL FRONTEND HACIA  POSTGRESQL  ********* */
  this.editar = (id) => {
    var form = new FormData();
    form.append("id", id);
    fetch("../controllers/editar.php", {
  ...
  /**********************ELIMINAR LOS EMPLEADOS DESDE EL FRONTEND AUTOMATICO SE ACTUALIZAA POSTGRESQL  ********* */
  this.eliminar = (id) => {
    var form = new FormData();
    form.append("id", id);
    fetch("../controllers/eliminar.php", {
  ...
  /**********************LIMPIAR LOS EMPLEADO EN EL LISTADO DEL FRONTEND ********* */
  this.limpiar = () => {
    this.primernombre.value = "";
    this.segundonombre.value = "";
    this.primerApellido.value = "";
